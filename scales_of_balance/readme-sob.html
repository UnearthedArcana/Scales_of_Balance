...
<div class="section">
  ...
  <ul>
  	...
  	<li>I have not tested compatibility with Kit Revisions. These two mods cover a lot of the same ground. Eventually (after KR is actually released, anyway) I will try to see if I can make them work well together. But for now, you should probably choose one or the other. (You may try to skip the SoB tweaks and only install new kits, and/or the multiclass component... it should work, but there might be balance issues.)</li><br />
  	<li>The first component of <u>Rogue Rebalancing</u> is not compatible, and not necessary, with SoB's component 7 "the Proficiency Overhaul." Also, SoB and RR's Bard Tweaks component modify some of the same resources; be aware that you might see some different behavior depending on which you install last.</li><br />
  	<li>Most of SoB's class tweaks are incompatible with the first, "core" component of <u>Six's Kitpack</u>. Take a look at what they do and decide which one you want to use. The kits in Six's Kitpack, however, should work fine with SoB. In particular, if you install Six's Hunter of Silvanus and SoB's Druid Tweaks, the Hunter will be able to wield bows just as Six intended :)</li><br />
  ...
  <p>If you install lots of kit mods, keep in mind that the kit selection screen can only show 10 kits per class - that's the main class plus nine kits. If you install a lot of kits, the Scales of Balance kits will not be selectable. This doesn't matter for clerics, since you can use items in-game to adopt those kits. But, for example, if you install all of the bard kits from Song & Silence, then you won't be able to see all of SoB's bard kits. The vanilla game has 4 kits in each class, so you can install six kits without worries. Plan ahead, or use the 'Mod Kit Remover' to clear space in the Character Generation screens.</p>
  <p><strong>Load Order:</strong><br />
    Scales of Balance should be installed after other mods that add or change items, and after all other mods that add kits. It should be installed after the "WSPATCK for All" component of <u>tb#Tweaks</u>. It should be installed <b>before</b> <u>Sword Coast Stratagems</u>.</p>
  <p>A special note about <u>Refinements</u> HLAs: most of Scales of Balance should be installed. But, the druid shapechange revisions should be installed after Refinements. At the moment, this means skipping the druid component the first time through; after you install Refinements, run 'setup-SoB' again. At the prompt about components already installed press [S]kip; at the prompt for components not yet installed, press [A]sk. Then install the druid shapechange component.</p>
...
<div class="section">
  ...
  <div class="section">
    ...
    <div class="kit_description">
      ...
      <p>Advantages:<br />
        ...
        &ndash; May Shapeshift into the form of a fire elemental, at 14th.<br />
  ...
  <div class="section">
    ...
    <p>CANTRIPS: each specialist will have a single cantrip relating to their field which they will be able to cast at will. Generalists can choose any three of the eight cantrips. Here's the list:</p>
    <ul>
    ...
    <p>METAMAGIC: spell sequencers become innate abilities. They are learned like spells, but once cast they will be removed from the wizard's spellbook. Thenceforth, they can be created from the innate abilities button. A sequencer can be re-created as soon as it is spent. Contingency becomes an innate ability instead of a spell, granted at level 11.</p>
    <p>SPELL BATTLES: Spell Thrust and Minor Spell Deflection (renamed "Parry Magic") become repeatable innate abilities, acquired at levels 3 and 5. Parry Magic deflects 2 spell levels; Spell Thrust will affect spell protections of level equal to the caster's level divided by 3. Secret Word deafness a Deafness secondary effect. Ruby Ray of Reversal gains a Blindness secondary effect. Pierce Shield gains a Breach secondary effect. Minor Spell Turning, Spell Deflection, and Spell Turning become Minor Spell Absorption, Spell Absorption, and Greater Spell Absorption, respectively.</p>
    <p>SPELL TWEAKS: numerous spells are moved to different schools to be more sensible and balance the list of spells available from each school (this will not affect the player much, because there are no longer any opposition schools - see below). Some spells are moved to different levels, such as Luck and Shapechange. Some spells are revised and improved, such as Ray of Enfeeblement and Energy Drain. Finally, wizards can o longer summon a Planetar as an HLA; instead they may summon greater elementals. The Planetar is summoned by clerics in place of the Deva, when he summoning cleric is higher than 25th level. <strong>The HLA summoning changes may be skipped by adjusting a setting in the .ini file.</strong></p>
  ...
  <h4 class="subheader">Component 660: </h4>
  <div class="section">
    <p><strong><em>Arcane Crafting by Gramarsalad</em></strong></p>
    <p>This component allows all wizards to scribe scrolls, similar to the aTweaks component. Additionally, Transmuters will be able to brew potions, and Enchanters will be able to create magical wands.</p>
    <p><strong>This component is very experimental and largely untested!</strong> I'm pretty sure it will not play with with Item Revisions and Spell Revisions. Use at your own risk! (Nothing should break; probably just the crafting skills might act weird.)</p>
  </div>
  <h4 class="subheader">Component 690: </h4>
  <div class="section">
    <p><strong><em>Saving Throw Standardization</em></strong></p>
    <p>This component changes all spells so that the saving throws they offer follow these guidelines:<br />
    <ul>
      <li>Direct magical effects like Charms and Illusions offer saves vs. Spells. This includes spells like Hold Person and Confusion.</li>
...
<div class="section">
  ...
  <ul>
    ...
    <li>Faldorn = Purifier</li>
  </ul>
  <p><strong>Version 2.8 - March 15, 2015</strong></p>
  <ul>
    <li>Added Mistwalker of Leira, multiclass Gloryblood of Tempus, and multiclass High Mage</li>
    <li>Khalid = Woodscout and Branwen = Gloryblood</li>
    <li>Tweaks to Spellfilcher, Alaghor</li>
  </ul>
  <p><strong>Version 2.7 - March 9, 2015</strong></p>
  <ul>
    <li>Bug fixes and streamlining</li>
    <li>Xan = Bladesinger</li>
  </ul>
  ...
  <ul>
    <li>Compatibility with the proficiency overhaul aded for ~40 mod NPCs</li>
  </ul>
  <p><strong>Version 0.9 - October 2, 2014</strong></p>
  <ul>
    <li>Item tweaks</li>
  </ul>
  <p><strong>Version 0.8 - September 25, 2014</strong></p>
  <ul>
  ...
  <ul>
    ...
    <li>New kits: Harrier, Barbarian Ranger, Moon Knight, Silkwhisper, Monitor, Gloryblood, Darkcload, and Beastheart</li>
  </ul>
